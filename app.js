(function () {
  ...
  const PROJECTS = [
    {
      ...
      images: [
        { src: "images/markdown-editor.png", alt: "Markdown Editor screenshot" }
      ],
    ...
    },
    {
      ...
      images: [
        { src: "images/label-designer.png", alt: "Label Designer screenshot" }
      ],
    ...
    },
    {
      ...
      overview: "Full-stack web application for accounting workflows: invoicing, reporting, and data management. Includes role-based access, dashboards, and export features for business use. I led a total redesign of the front end—drag the slider below to compare before and after.",
      beforeAfter: true,
      images: [
        { src: "images/markdown-editor.png", alt: "Planet Accounting — before (placeholder until you add planet-accounting-before.png)" },
        { src: "images/label-designer.png", alt: "Planet Accounting — after (placeholder until you add planet-accounting-after.png)" }
      ],
      liveUrl: null,
      codeUrl: null,
    ...
    },
    {
      ...
      images: [
        { src: "https://placehold.co/800x450/2b2b2b/888?text=Lead+Generator", alt: "Lead Generator screenshot" }
      ],
      liveUrl: null,
      codeUrl: null,
    ...
    },
    {
      ...
      images: [
        { src: "https://placehold.co/800x450/2b2b2b/888?text=National+Theater+Kosovo", alt: "National Theater of Kosovo management tool screenshot" }
      ],
      liveUrl: null,
      codeUrl: null,
      tags: ["React", "TypeScript", "Node.js", "PostgreSQL"]
  ...
  function showSection(id) {
    ...
    if (id === "projects") showProjectList();
    if (navEl) {
    ...
    if (toolbar) toolbar.classList.toggle("content-toolbar--hidden", id === "home");
  ...
  function setupNavigation() {
    ...
    try {
      ...
      if (saved && SECTIONS.includes(saved)) showSection(saved);
      else {
        var currentId = document.querySelector(".nav-item.active")?.getAttribute("data-section") || "home";
        var toolbar = document.querySelector(".content-toolbar");
        if (toolbar) toolbar.classList.toggle("content-toolbar--hidden", currentId === "home");
      }
    } catch (e) {}
  }
